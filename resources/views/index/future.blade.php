<section id="section-start-journey" class="section-50 section-sm-90 section-lg-top-120">
    <div class="shell">
        <div class="range range-md-middle range-sm-center">
            ...
            <div class="cell-sm-11 cell-md-4 offset-top-0 offset-sm-top-60 offset-md-top-0">
                <div class="image-group hide-none show-sm" style="text-align: right">
                    <figure></figure>
...
<section class="section-bottom-60">
    ...
    <div class="shell">
        <div class="range  range-sm-center">
            <div data-wow-duration="2s" data-wow-offset="200" class="cell-sm-12 offset-top-40  cell-md-5 wow fadeInLeft text-secondary">
                {!! Voyager::setting('bring-index-left') !!}
            </div>
            <div class="cell-sm-12 cell-md-7 offset-top-40">
                <div data-wow-duration="2s" data-wow-offset="200" class="wow fadeInRight text-secondary">
