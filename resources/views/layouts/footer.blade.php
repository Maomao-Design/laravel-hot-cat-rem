    ...
    <div class="shell">
        <div class="range range-xs-center">
            <div class="cell-xs-10 cell-sm-11 cell-md-12">
                <div class="range">
                    <div class="cell-sm-6 cell-md-4 text-sm-left text-center section-md-top-15">
                    ...
                    <div class="cell-sm-6 cell-md-4  text-sm-left text-center section-sm-top-35 section-md-top-15">
